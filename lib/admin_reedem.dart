...
@override
  ...
  Widget allApprovals(){
    return StreamBuilder(
      stream: reedemStream, builder: (context, AsyncSnapshot snapshot){
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      SizedBox(width: 10.0,),
                      Text("UPI ID:"+ds["UPI"], style: AppWidget.normaltextstyle(18.0),),
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: MediaQuery
                  ...
                  .size
                  .width / 7,),
              Text("Reedem Approval", style: AppWidget.headlinetextstyle(25.0)),
            ],
          ),
        ),
